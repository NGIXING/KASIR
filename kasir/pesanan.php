...
LEFT JOIN bayar ON bayar.id_bayar = tb_penjualan.id_penjualan
...
<script>
    function printStruk() {
      // Menyimpan URL sebelum menggantinya
      var url = window.location.href;
      // Ganti URL dengan nama toko Anda
      var Struk = document.getElementById("Struk").innerHTML.replace(/localhost/g, "");
      ...
      // Mengembalikan URL setelah selesai mencetak
