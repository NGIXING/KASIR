...
<nav class="navbar navbar-expand border-bottom border-body bg-secondary sticky-top" data-bs-theme="dark">
        <div class="container-lg">
            <a class="navbar-brand" href="."><i class="bi bi-shop"></i> XING</a>
                ...
                <form class="text-center needs-validation" novalidate action="proses/ubah-password.php" method="POST">
                  ...
                  <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="raihan" name="username"
              ...
              <div class="modal-body">
                <form class="text-center needs-validation" novalidate action="proses/ubah-profile.php" method="POST">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="raihan" name="nama"
