...
<div class="col-lg-9 mt-2">
    <div class="card">
        <h5 class="card-header">Rekap Penjualan</h5>
        <div class="card-body">
            <?php 
            $total= 0;
            if(empty($result)) {
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                           ...
                           <td class="d-flex">
                            <a class="btn btn-info btn-sm me-1" href="./?x=pesanan&idpenjualan=<?php echo $row['id_penjualan']."&namapl=".$row['nama_pelanggan'] ?>"><i class="bi bi-pen"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
