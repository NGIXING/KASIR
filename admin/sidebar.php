...
<div class="col-lg-3">
                <nav class=" -expand-lg rounded navbar mt-2 mb-1">
                        ...
                        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav nav-tabs flex-column justify-content-end flex-grow-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link <?php echo (isset($_GET['x']) && $_GET['x']=='penjualan') ? "active link-light bg-secondary" : "" ; ?> ps-2" href="penjualan"><i class="bi bi-cart2"></i> Rekap Penjualan</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
